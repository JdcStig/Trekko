...
const EditSessionModal = ({ show, onHide, onCSVCancel, onEditSession, session }) => {
  ...
  const validateSplits = () => {
    for (let i = 0; i < localSessionData.splits.length; i++) {
      const split = localSessionData.splits[i];
                  ...
                  <tr key={index}>
                    ...
                    <td>
                      <Form.Control
                        ...
                        onChange={(e) =>
                          handleSplitChange(index, 'start', timeStringToSeconds(e.target.value))
                        }
                        required
                      />
                    </td>
                    <td>
                      <Form.Control
                        ...
                        onChange={(e) =>
                          handleSplitChange(index, 'end', timeStringToSeconds(e.target.value))
                        }
                        required
                      />
                    </td>
