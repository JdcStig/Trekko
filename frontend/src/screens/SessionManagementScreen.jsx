...
// import SessionCharts from '../components/SessionCharts'; // Import your two-charts component
...
//       // Basic numeric or string comparisons...
//       // (Your existing logic)
//       return 0;
//     });
//   }
...
//     setSelectedSession(session); // Must include the real _id
...
//                   <td>
//                     {session.avgDistance
//                       ? session.avgDistance.toFixed(2) + ' km'
//                       : 'N/A'}
//                   </td>
//                   <td>
...
//           {/* Show charts for the selected session */}
...
//         session={selectedSession} // includes real _id
//       />
...
const SessionManagementScreen = () => {
  ...
  // New state for expanded rows to show split details
              ...
              {currentItems.map((session) => (
                <React.Fragment key={session._id}>
                  <tr>
                    ...
                    <td>
                      <Button variant="light" className="btn-sm" onClick={() => handleEditClick(session)}>
                        <FaEdit />
                      </Button>
                    </td>
                    <td>
                      <Button variant="light" className="btn-sm" onClick={() => handleDeleteClick(session)}>
                        <FaTrash />
                      </Button>
                    </td>
                    <td>
                      <Button variant="light" className="btn-sm" onClick={() => handleShowChart(session._id)}>
                        <FaChartLine />
                      </Button>
                    </td>
                  </tr>
                          ...
                          <tbody>
                            {session.splits && session.splits.map((split, idx) => (
                              <tr key={idx}>
                                ...
                                <td>{new Date(split.start * 1000).toLocaleTimeString()}</td>
                                <td>{new Date(split.end * 1000).toLocaleTimeString()}</td>
                              </tr>
                            ))}
                          </tbody>
                        </Table>
